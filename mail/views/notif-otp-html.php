                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td style="padding: 20px 0 30px 0">
                                ...
                                <p>OTP Anda adalah : <b><?= $model->otp ?></b>.</p>
                                <p>Jangan bagikan kode OTP kepada siapapun. Untuk alasan apapun, jangan pernah membagikan one-time password ke siapapun. Pihak KCIC resmi sendiri juga tidak akan meminta kode tersebut.</p>
                            </td>
                        <tr>
